...
|---------------|------------------------|----------------------|
| **Clip** | Lapina TikTok | YouTube → short vertical + subtítulos automáticos + voz en off. Producción de video real. |
...
| **Twitter/Social** | Lapina sub-agents | Posteo autónomo con approval gates obligatorios → Ivette aprueba antes de publicar. |
...
# Lapina quiere postear → Ivette debe aprobar primero
POST /api/openfang
{
  "mode": "send_channel",
  "platform": "telegram",
