...
const sphereAgents: Agent[] = [
  { id: "alex", name: "ALEX™", role: "Strategy Director", sphere: "El Arquitecto", color: "var(--color-sphere-alex)", status: "active", lastAction: "Generating Q3 strategy deck", lastActionTime: "2m ago", tasksCompleted: 847, tasksPending: 3, uptimePercent: 99.8, memoryMb: 124, cpuPercent: 12 },
  { id: "seductora", name: "SEDUCTORA™", role: "Conversion Specialist", sphere: "La Seductora", color: "var(--color-sphere-seductora)", status: "processing", lastAction: "A/B test landing CDMX", lastActionTime: "1m ago", tasksCompleted: 623, tasksPending: 5, uptimePercent: 99.5, memoryMb: 89, cpuPercent: 34 },
  { id: "cazadora", name: "CAZADORA™", role: "Lead Hunter", sphere: "La Cazadora", color: "var(--color-sphere-cazadora)", status: "active", lastAction: "LinkedIn scan — Madrid C-suite", lastActionTime: "5m ago", tasksCompleted: 1204, tasksPending: 12, uptimePercent: 99.9, memoryMb: 156, cpuPercent: 8 },
  { id: "forjadora", name: "FORJADORA™", role: "Content Creator", sphere: "La Forjadora", color: "var(--color-sphere-forjadora)", status: "idle", lastAction: "Published 3 social posts", lastActionTime: "23m ago", tasksCompleted: 456, tasksPending: 0, uptimePercent: 98.2, memoryMb: 67, cpuPercent: 2 },
  { id: "cultura", name: "DRA. CULTURA™", role: "Cultural Intelligence", sphere: "Dra. Cultura", color: "var(--color-sphere-cultura)", status: "active", lastAction: "LATAM market brief updated", lastActionTime: "8m ago", tasksCompleted: 389, tasksPending: 2, uptimePercent: 99.1, memoryMb: 98, cpuPercent: 15 },
  { id: "teknos", name: "ING. TEKNOS", role: "Tech Infrastructure", sphere: "Ing. Teknos", color: "var(--color-sphere-teknos)", status: "active", lastAction: "Monitoring deploy pipeline", lastActionTime: "30s ago", tasksCompleted: 2103, tasksPending: 1, uptimePercent: 99.95, memoryMb: 210, cpuPercent: 22 },
  { id: "economia", name: "DR. ECONOMÍA", role: "Financial Analysis", sphere: "Dr. Economía", color: "var(--color-sphere-economia)", status: "active", lastAction: "Revenue forecast updated", lastActionTime: "12m ago", tasksCompleted: 567, tasksPending: 2, uptimePercent: 99.7, memoryMb: 112, cpuPercent: 10 },
  { id: "verdad", name: "SRA. VERDAD", role: "Truth Verification", sphere: "Sra. Verdad", color: "var(--color-sphere-verdad)", status: "idle", lastAction: "Fact-checked 14 claims", lastActionTime: "45m ago", tasksCompleted: 789, tasksPending: 0, uptimePercent: 99.3, memoryMb: 78, cpuPercent: 1 },
  { id: "guardian", name: "GUARDIÁN", role: "Security & Compliance", sphere: "El Guardián", color: "var(--color-sphere-guardian)", status: "active", lastAction: "Security audit — all clear", lastActionTime: "3m ago", tasksCompleted: 1456, tasksPending: 1, uptimePercent: 99.99, memoryMb: 188, cpuPercent: 18 },
  { id: "vigilante", name: "LA VIGILANTE", role: "System Overseer", sphere: "Overseer", color: "var(--color-gold-400)", status: "active", lastAction: "All systems nominal", lastActionTime: "10s ago", tasksCompleted: 5678, tasksPending: 0, uptimePercent: 100, memoryMb: 256, cpuPercent: 5 },
];
