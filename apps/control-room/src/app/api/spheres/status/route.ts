...
const SPHERES = [
  ...
  { id: "dr-economia",  name: "DR. ECONOMÍA", role: "Analista Financiero",     color: "#f97316" },
  { id: "dra-cultura",  name: "DRA. CULTURA", role: "Estratega Cultural",      color: "#f43f5e" },
  { id: "ing-teknos",   name: "ING. TEKNOS",  role: "Ingeniero de Sistemas",   color: "#06b6d4" },
  { id: "la-vigilante", name: "LA VIGILANTE", role: "Guardiana / Watcher",     color: "#64748b" },
];
