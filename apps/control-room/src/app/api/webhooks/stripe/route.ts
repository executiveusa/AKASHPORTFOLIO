...
// Security: guard=none is intentional — this route verifies the Stripe webhook signature via stripe.webhooks.constructEventAsync. Do not add a generic guard.
