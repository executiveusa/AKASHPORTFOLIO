    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      ...
      <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-5xl sm:text-6xl font-black tracking-tighter mb-6 bg-gradient-to-r from-amber-400 via-orange-400 to-red-500 bg-clip-text text-transparent">
      ...
      <footer className="border-t border-slate-800 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <p className="text-center text-slate-400">
            {language === 'es'
              ? 'ALEX™ // 50+ Poderes de IA // Creado por Kupuri Media™'
              : 'ALEX™ // 50+ AI Powers // Created by Kupuri Media™'
            }
          </p>
        </div>
      </footer>
